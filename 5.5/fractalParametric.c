//gcc fractalParametric.c -o fractalParametric -lglut -lm -lGLU -lGL
#include <GL/glut.h>
#include <math.h>
#include <stdio.h>
//#include <device.h>
...
double rootObjectX(double t)
{
	return(sin(t)+1.0 + 10.0);
}

double rootObjectY(double t)
{
	return(cos(t)+1.0 + 10.0);
}
