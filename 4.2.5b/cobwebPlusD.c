//gcc cobwebPlusD.c -o cobwebPlusD -lglut -lm -lGLU -lGL
#include <GL/glut.h>
#include <math.h>
#include <stdio.h>
//#include <device.h>
...
void draw_bound_lines()
{
	...
	glBegin(GL_LINE_LOOP);
		glVertex2f(x_world_to_x_screen(X_MIN),y_world_to_y_screen(2.2));
		glVertex2f(x_world_to_x_screen(X_MAX),y_world_to_y_screen(2.2));
	glEnd();
